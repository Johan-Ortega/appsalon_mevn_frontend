    ...
    <div class="flex justify-between">
        ...
        <div class=" flex flex-col space-y-5">
            <div class="flex gap-2 items-center">
                ...
                <button
                    type="button"
                    class="bg-red-600 hover:bg-red-700 p-2 text-white uppercase text-sm font-bold rounded-lg"
                    @click="user.logout"
                >
                    Cerrar Sesión
                </button>
            ...
            <nav class="flex gap-2 items-center justify-end">
                ...
                <RouterLink
                    ...
                    class="p-3 text-gray-200 uppercase text-sm font-2xl rounded-lg bg-blue-700 font-bold"
                >
                    Nueva Cita
                </RouterLink>
            </nav>
